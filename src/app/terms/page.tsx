  ...
  return (
    <div className="pt-28 pb-20 bg-white dark:bg-slate-950 min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <h1 className="text-3xl font-black text-[#0a1628] dark:text-white mb-2">Terms of Use</h1>
        ...
        <div className="prose prose-sm max-w-none text-slate-600 dark:text-slate-300 space-y-6">
          ...
          <h2 className="text-lg font-black text-[#0a1628] dark:text-white">Use of Website</h2>
          ...
          <h2 className="text-lg font-black text-[#0a1628] dark:text-white">Intellectual Property</h2>
          ...
          <h2 className="text-lg font-black text-[#0a1628] dark:text-white">Limitation of Liability</h2>
          ...
          <h2 className="text-lg font-black text-[#0a1628] dark:text-white">Contact</h2>
