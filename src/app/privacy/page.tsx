  ...
  return (
    <div className="pt-28 pb-20 bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <h1 className="text-3xl font-black text-[#0a1628] mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-sm max-w-none text-slate-600 space-y-6">
          ...
          <h2 className="text-lg font-black text-[#0a1628]">Information We Collect</h2>
          ...
          <h2 className="text-lg font-black text-[#0a1628]">How We Use Your Information</h2>
          ...
          <h2 className="text-lg font-black text-[#0a1628]">Contact Us</h2>
